...
export const AddContact = () => {
	...
	const [contact, setContact] = useState({
		full_name: "",
		email: "",
		agenda_slug: store.agenda, //es la agenda seleccionada
		address: "",
		phone: ""
	});
		...
		<div className="container">
			<div>
				...
				<form>
					...
					<div className="form-group">
						<label>Agenda</label>
						<input type="text" name="agenda_slug" className="form-control" placeholder="Enter email" value={contact.agenda_slug} //lo guarda en la agenda q está
						//si quiero una agenda nueva, borro la q me sale por defecto
							onChange={handleChange} />
					</div>
					<div className="form-group">
						<label>Phone</label>
